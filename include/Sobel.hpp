...
do { \
    ...
    v_src0 = _mm256_loadu_si256((__m256i*)(src0 + 2)); \
	v_src1 = _mm256_loadu_si256((__m256i*)(src1 + 2)); \
	v_src2 = _mm256_loadu_si256((__m256i*)(src2 + 2)); \
	v_src3 = _mm256_loadu_si256((__m256i*)(src3 + 2)); \
	v_src4 = _mm256_loadu_si256((__m256i*)(src4 + 2)); \
	v_src5 = _mm256_loadu_si256((__m256i*)(src5 + 2)); \
	...
	v_src3 = _mm256_loadu_si256((__m256i*)(src3)); \
	v_src4 = _mm256_loadu_si256((__m256i*)(src4)); \
	v_src5 = _mm256_loadu_si256((__m256i*)(src5)); \
	...
	v_src1 = _mm256_loadu_si256((__m256i*)(src1 + 1)); \
	v_src2 = _mm256_loadu_si256((__m256i*)(src2 + 1)); \
	v_src3 = _mm256_loadu_si256((__m256i*)(src3 + 1)); \
	v_src4 = _mm256_loadu_si256((__m256i*)(src4 + 1)); \
	v_src5 = _mm256_loadu_si256((__m256i*)(src5 + 1)); \
	v_gy1 = _mm256_sub_epi16(v_gy1, v_src0); \
	v_gy2 = _mm256_sub_epi16(v_gy2, v_src1); \
	v_gy3 = _mm256_sub_epi16(v_gy3, v_src2); \
	v_gy4 = _mm256_sub_epi16(v_gy4, v_src3); \
